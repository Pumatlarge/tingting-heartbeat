...
ACHIEVEMENTS = [
    ...
    ("streak_3", "三日相见", "连续启动 3 天。", "streak_days", 3),
    ("streak_7", "一周之约", "连续启动 7 天。", "streak_days", 7),
    ("streak_30", "月度陪伴", "连续启动 30 天。", "streak_days", 30),
    ...
    ("streak_100", "百日之约", "连续启动 100 天。", "streak_days", 100),
    ("streak_365", "四季相伴", "连续启动 365 天。", "streak_days", 365),
